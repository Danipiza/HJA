...
public class MainWindow extends JFrame{
	...
	private void initGUI() {
		...
		combos.setBounds(780, 80, 1066, 700);
		...
		for (int i = 0; i < 4; i++) {
			...
			extraOptions.setBounds(780, 18, 190, 60);
			...
			all.setText("All");
			all.setFont(new Font("Arial", Font.PLAIN, 12));
		    all.setBounds(10,10,70,40);
			...
			JLabel _lbPerc = new JLabel();
			_lbPerc.setBounds(600, 660, 300, 50); 
			_lbPerc.setFont(new Font("Arial", Font.PLAIN, 20));
			add(_lbPerc);
